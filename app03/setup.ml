...
(* OASIS_START *)
(* DO NOT EDIT (digest: e60d8de28373402f2c222585556dcd55) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["botamotch <laughing00boomer@gmail.com>"];
          homepage = Some "https://github.com/botamotch/OCaml";
          bugreports = None;
          synopsis = "A Example program about Foureier Transform Example";
          description =
            Some
              [
                 OASISText.Para
                   "A Example program about Foureier Transform Example"
              ];
          tags = [];
          categories = [];
          files_ab = [];
     ...
     oasis_digest = Some "\151\224\200\025\174BB\239\162 \185\n!-\223\024";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
